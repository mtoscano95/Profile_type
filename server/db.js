...
/*
 COMING FOM STORE FOR #3


We go to the before save hook and check to see if the user had their password changes using the changed method
Itll happen when user is created and when user updates their password
